...
#else
           CALL invfft_orbital_gamma(psi_d,ibnd,nbnd)
#endif
...
#else
        CALL fwfft_orbital_gamma(spsi_d,1,1)
#endif
        !
     ELSE
        !
...
#else
           CALL invfft_orbital_k(psi_d,ibnd,nbnd)
#endif
           ! global becp%r is updated
...
#else
        CALL fwfft_orbital_k( spsi_d, 1, 1 )
#endif
        !
     ENDIF
     !
...
#if defined (__OPENMP_GPU)
     CALL calbec_gpu( n, vkb, psi_d, becp)
#else
